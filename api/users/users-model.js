...
function bul() {
  ...
  // Tablolar birleştirilir, istenilen datalar alınır.
}

// goreBul({username:"burcu"})
...
function goreBul(filtre) {
  ...
  //filtre ile eşleşen datalar çekilir.array isteniyor.
}
...
function idyeGoreBul(user_id) {
  ...
  return db("users as u")
    ...
    .first();
  //Verilen id'ye sahip kulllanıcı obje olarak çekilir.
}
